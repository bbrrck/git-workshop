...
- Prihlasovacie údaje sú spravované cez [Git Credential Manager](https://github.com/GitCredentialManager/git-credential-manager) ktorý je súčasťou [Git for Windows](https://gitforwindows.org/). 
...
::: {.columns}
::: {.column width=50%}
![](img/gh-win-auth/auth-confirm.png){.gh-win-auth width=80%}
:::

::: {.column width=50%}
![](img/gh-win-auth/auth-success.png){.gh-win-auth}
:::
:::
...
- Existujúci vzdialený repozitár môžeme naklonovať (vytvoriť lokálnu kópiu) pomocou `git clone`:
```zsh
